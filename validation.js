function Validator(formSelector) {
    ...
    if (formElement) {
        ...
        function handleValidate(event) {
            ...
            //Nếu có lỗi hiện thị message lỗi ra UI
            if (errorMessage) {
                var formGorup = getParent(event.target, '.form-group')
                if (formGorup) {
                    formGorup.classList.add('invalid');
                    var formMessage = formGorup.querySelector('.form-message');
                    if (formMessage) {
        ...
        function handleClearError(event) {
            var formGorup = getParent(event.target, '.form-group')
            if (formGorup.classList.contains('invalid')) {
                formGorup.classList.remove('invalid');
                var formMessage = formGorup.querySelector('.form-message');
                if (formMessage) {
